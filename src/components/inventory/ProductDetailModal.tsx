    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/80 backdrop-blur-sm animate-fadeIn">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                ...
                {!isReadOnly && (
                  <button
                    ...
                    title="Liquidación y Ofertas / Armar Packs Promocionales"
                  >
      ...
      {isOfferModalOpen && (
        <div className="fixed inset-0 z-60 flex items-center justify-center p-3 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="w-full max-w-xl max-h-[92vh] overflow-y-auto custom-scrollbar rounded-3xl border-2 border-amber-400 bg-white dark:bg-slate-900 shadow-2xl p-5 space-y-4 animate-scaleIn">
            ...
            {/* SUBMENÚ DE OPCIONES DE LIQUIDACIÓN */}
            <div className="grid grid-cols-2 gap-2 p-1.5 bg-slate-100 dark:bg-slate-800/80 rounded-2xl border border-slate-200 dark:border-slate-700">
              <div className="py-2.5 px-3 rounded-xl font-black text-xs flex items-center justify-center gap-2 bg-white dark:bg-slate-900 text-amber-700 dark:text-amber-300 shadow-sm border border-amber-300 dark:border-amber-600/60">
                <Tag className="w-4 h-4 text-amber-600" />
                <span>1. Liquidación Individual</span>
              </div>
              <button
                type="button"
                onClick={() => {
                ...
                className="py-2.5 px-3 rounded-xl font-black text-xs flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white shadow-md active:scale-95 transition cursor-pointer"
                title="Armar packs y combos sumando más productos con nuevo código"
              >
                <Package className="w-4 h-4" />
                <span>2. 🎁 Generar Pack / Promo</span>
              </button>
            </div>

            {/* Banner explicativo para armar packs */}
            <div className="p-3 rounded-2xl bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/40 dark:to-amber-950/40 border border-orange-300 dark:border-orange-700 flex flex-col sm:flex-row items-center justify-between gap-3 shadow-xs">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-xs font-black text-orange-950 dark:text-orange-200">
                    ¿Quieres armar un combo promocional sumando más productos?
                  </p>
                  <p className="text-[11px] text-slate-600 dark:text-slate-400 font-medium">
                    Calcula packs según el stock disponible, crea un código nuevo y descuenta el inventario automáticamente.
                  </p>
                </div>
              </div>
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white font-black text-xs shadow-md transition active:scale-95 shrink-0 flex items-center justify-center gap-1.5 cursor-pointer"
              >
                <Package className="w-4 h-4" />
                <span>Armar Pack Ahora</span>
              </button>
            </div>
